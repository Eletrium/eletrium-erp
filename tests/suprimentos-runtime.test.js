...
(async function executableBoundaryCombinesSchemaRbacAndHandler() {
  ...
  const base = { commandId: 'cmd1', operation: 'reserve', actorId: 'operator', correlationId: 'corr1', idempotencyKey: 'idem1', schemaVersion: '1.0.0', payload: { documentId: 'd1', documentVersion: 1, expectedVersions: { m1: 0 }, items: [{ itemId: 'i1' }] } };
